...
class OfflineApartmentAdapter(
    private val onItemClick: (Apartment) -> Unit = {}
) : ListAdapter<Apartment, OfflineApartmentAdapter.ApartmentViewHolder>(ApartmentDiffCallback()) {
    ...
    inner class ApartmentViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(apartment: Apartment) {
            ...
            try {
                ...
                image.setImageResource(R.drawable.baseline_assignment_late_24)
            }
        }
    }
